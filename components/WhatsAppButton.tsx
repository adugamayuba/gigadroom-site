  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="bg-[#111] border border-white/10 rounded-xl p-4 shadow-2xl max-w-[220px]"
          >
            <button
      ...
      <motion.button
        ...
        className="relative w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20c05c] shadow-2xl shadow-[#25D366]/30 flex items-center justify-center transition-all duration-200 hover:scale-110"
